...
public class Desenvolvedor(string nome, string cpf, decimal salarioBase, DateTime dataAdmissao) : Funcionario(nome, cpf, salarioBase, dataAdmissao)
{
    public override TipoFuncionarioEnum Cargo => TipoFuncionarioEnum.Desenvolvedor;
    public decimal TaxaBonus { get; } = 0.15m;
